...
const Home = () => {
  ...
  return (
    <Box className="flex flex-col items-center">
        <Typography className="text-[20px] font-semibold">CURD APP </Typography>
        <Box className="flex justify-evenly flex-wrap gap-10 mx-[10px] my-[20px]">
      {postData.slice(  page * paginationRef.current.limit - 10,
        page * paginationRef.current.limit).map((value: POSTTYPE) => {
